...
define('PAYTM_MERCHANT_MID', 'fDlkIy64148311435937'); //Change this constant's value with MID (Merchant ID) received from Paytm.
define('PAYTM_MERCHANT_WEBSITE', 'WEB_STAGING'); //Change this constant's value with Website name received from Paytm.
define('PAYTM_TXN_URL', 'https://pguat.paytm.com/oltp-web/processTransaction');
